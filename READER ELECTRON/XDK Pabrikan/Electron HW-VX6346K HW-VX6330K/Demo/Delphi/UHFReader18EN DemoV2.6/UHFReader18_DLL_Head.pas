...
Const
    ...
    UHFReader18_DLLName = 'UHFReader18.dll'; // ''
...
type
    ...
    Function OpenNetPort(Port : LongInt;
                    IPaddr:string;
                     var ComAdr : byte;
                     var frmcomportindex:longint): LongInt; stdcall;external UHFReader18_DLLName ;
    Function CloseNetPort( frmComPortindex : longint ): LongInt; stdcall; external UHFReader18_DLLName ;
   ...
   function BuzzerAndLEDControl(var ComAdr:Byte;
    ...
    Function SetRelay(var ComAdr:Byte;RelayStatus :Byte;frmComPortindex: longint):LongInt; stdcall;external UHFReader18_DLLName ;
