...
uses
  ...
  UHFReader18_Head,UHFReader18_DLL_Head,fProgress, IdBaseComponent,
...
procedure TfrmUHFReader18demomain.Button11Click(Sender: TObject);
var
  comd:string;
  aDateTime: TDateTime;
...
procedure TfrmUHFReader18demomain.Button12Click(Sender: TObject);
begin
 locateForm.Show ;
end;
